<template>
  ...
  >
    ...
    <span class="property-symbol">
      ...
      <!-- Trans-Aktion (Materialkollision) -->
      <svg v-else-if="property === 'trans_aktion'" xmlns="http://www.w3.org/2000/svg" height="48" viewBox="0 -960 960 960" width="48" fill="currentColor">
